...
class ChevalierMage : virtual public Chevalier, virtual public Mage
{
	...
	public:
		...
		ChevalierMage(const std::string& name, const std::string& attack_name, const int& life_point, const int& magic_attack_point, const int& pm_point, const int& defense_point);
...
class MageVoleur : virtual public Mage, virtual public Voleur
{
	...
	public:
		...
		MageVoleur(const std::string& name, const std::string& attack_name, const int& life_point, const int& melee_attack_point, const int& magic_attack_point, const int& pm_point);
...
class MagePretre : virtual public Mage, virtual public Pretre
{
	...
	public:
		...
		MagePretre(const std::string& name, const std::string& attack_name, const int& life_point, const int& magic_attack_point, const int& pm_point);
...
class ChevalierVoleur : virtual public Chevalier, virtual public Voleur
{
	...
	public:
		...
		ChevalierVoleur(const std::string& name, const std::string& attack_name, const int& life_point, const int& melee_attack_point, const int& defense_point);
...
class VoleurPretre : virtual public Voleur, virtual public Pretre
{
	...
	public:
		...
		VoleurPretre(const std::string& name, const std::string& attack_name, const int& life_point, const int& melee_attack_point, const int& heal_magic_point, const int& pm_point);
