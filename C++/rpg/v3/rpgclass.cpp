...
ChevalierMage::ChevalierMage(const string& name, const std::string& attack_name, const int& life_point, const int& magic_attack_point, const int& pm_point, const int& defense_point)
:	Perso(name, attack_name, life_point, magic_attack_point/2),
	Chevalier(name, attack_name, life_point, magic_attack_point/2, defense_point),
	Mage(name, attack_name, life_point, magic_attack_point, pm_point)
{}
...
MageVoleur::MageVoleur(const std::string& name, const std::string& attack_name, const int& life_point, const int& melee_attack_point, const int& magic_attack_point, const int& pm_point)
:	Perso(name, attack_name, life_point, melee_attack_point),
	Mage(name, attack_name, life_point, magic_attack_point, pm_point),
...
MagePretre::MagePretre(const std::string& name, const std::string& attack_name, const int& life_point, const int& magic_attack_point, const int& pm_point)
:	Perso(name, attack_name, life_point, 0),
	Mage(name, attack_name, life_point, magic_attack_point, pm_point),
	Pretre(name, attack_name, life_point, 0, pm_point),
	max_pm(pm_point),
	actual_pm(pm_point)
{}
...
ChevalierVoleur::ChevalierVoleur(const std::string& name, const std::string& attack_name, const int& life_point, const int& melee_attack_point, const int& defense_point)
:	Perso(name, attack_name, life_point, melee_attack_point),
	Chevalier(name, attack_name, life_point, melee_attack_point, defense_point*0.5),
	Voleur(name, attack_name, life_point, melee_attack_point)
{}
