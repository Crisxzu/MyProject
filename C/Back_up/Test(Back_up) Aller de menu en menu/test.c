...
struct_global __struct_global={NULL, NULL, NULL};
...
int main (int argc, char** argv)
{
	...
	GtkWidget *settings_menu_label=NULL, *settings_menu_box=NULL, *settings_menu_button_box=NULL, *settings_menu_return_button=NULL;
	GtkWidget *run_menu_label=NULL, *run_menu_box=NULL, *run_menu_button_box=NULL, *run_menu_return_button=NULL;
	const char *main_menu_title="Menu principal", *run_menu_title="Lancement", *settings_menu_title="Paramètres";
	...
	run_menu_button_box=gtk_button_box_new(GTK_ORIENTATION_HORIZONTAL);
